...
def _check_person(person: Profile):
    ...
    assert (
        person.linkedin_profile_url == "https://www.linkedin.com/in/gil-palma-fernandes"
    )
...
def test_scrape_linkedin_profile_2():
    ...
    person = extract_profile(
        ...
        extract_experiences_from_homepage=False,
    )
    assert person is not None
    ...
    assert len(person.educations) == 0
    assert (
        person.linkedin_profile_url == "https://www.linkedin.com/in/alexander-polev-cto"
    )
...
def test_scrape_linkedin_profile_4():
    ...
    assert (
        ...
        == "https://www.linkedin.com/in/donna-matthews-a8b0244"
    )
...
def test_scrape_linkedin_profile_5():
    ...
    assert person.surname == "(Jafari)"
    assert len(person.experiences) > 0
    # assert len(person.educations) > 0
    assert person.linkedin_profile_url == "https://www.linkedin.com/in/murtaza-hassani"
