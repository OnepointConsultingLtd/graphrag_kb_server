...
async def _create_relationships_table(schema_name: str):
    from graphrag_kb_server.service.db.db_persistence_search import create_search_history_tables
...
async def _drop_relationships_table(schema_name: str):
    from graphrag_kb_server.service.db.db_persistence_search import drop_search_history_tables
    from graphrag_kb_server.service.db.db_persistence_relationships import drop_relationships_table
...
async def test_save_relationships():
    from graphrag_kb_server.service.db.db_persistence_relationships import find_relationships, save_relationships
    from graphrag_kb_server.service.db.db_persistence_search import insert_search_query
    from graphrag_kb_server.test.service.db.search_history_provider import create_search_history
    ...
    try:
        ...
        search_history_id = await insert_search_query(
            Path(f"/var/graphrag/tennants/public/graphrag/{test_project.project.name}"), search_history
            )
