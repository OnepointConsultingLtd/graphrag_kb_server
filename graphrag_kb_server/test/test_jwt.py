...
from graphrag_kb_server.service.jwt import rename_to_folder, generate_token, decode_token
...
def test_generate_token():
    ...
    token_data = JWTTokenData(name=folder_name, email="test@test.com", time_delta_minutes=None)
