			...
			<div className="space-y-6">
				...
				{!success && (
					<div className="bg-gray-800/50 p-4 rounded-lg">
						<h4 className="font-medium text-gray-200 mb-2">Project to be deleted:</h4>
						<div className="space-y-1">
							<p className="text-lg font-semibold text-white">{selectionProject || "No project selected"}</p>
							{selectionPlatform && (
								<p className="text-sm text-gray-400">Platform: {selectionPlatform}</p>
							)}
						</div>
					</div>
				)}
