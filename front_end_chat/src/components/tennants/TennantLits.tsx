...
type TennantLitsProps = {
  onOpenModal: () => void;
  onOpenDeleteModal: (tenant: { folder_name: string; token: string }) => void;
};

export default function TennantLits({
  onOpenModal,
  onOpenDeleteModal,
}: TennantLitsProps) {
    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 mb-8 backdrop-blur-sm bg-gradient-to-br from-white to-gray-50">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex justify-between items-center gap-4">
          ...
          {/* Create New Tenant Button - Always visible */}
          <div className="flex">
            <Button
              onClick={onOpenModal}
              disabled={false}
                  ...
                  >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <CopyToClipboard
                          ...
                          handleCopyToClipboard={() =>
                            handleCopyToClipboard(tennant.token)
                          }
                        />
                    ...
                    <td className="px-8 py-6 whitespace-nowrap text-sm font-medium">
                      <button
                        onClick={() =>
                          onOpenDeleteModal({
                            folder_name: tennant.folder_name,
                            token: tennant.token,
                          })
                        }
