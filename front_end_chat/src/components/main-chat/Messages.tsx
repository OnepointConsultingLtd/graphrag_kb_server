...
function JokerButton() {
  ...
  return (
    <button className={`w-11 h-11 -mt-1 cursor-pointer filter hue-rotate-120 saturate-200 brightness-155 ${!isFloating ? "tooltip" : ""}`} 
      data-tip="Click for random topic" title={`${isFloating ? "Click for random topic" : ""}`} onClick={handleClick}>
...
function ConversationTopics() {
  ...
  return (
    <div className={`flex-1 flex items-center justify-center text-gray-500 ${isFloating ? "mt-0" : "mt-12"}`}>
      <div className="w-full text-center">
        ...
        {(hasTopics || showTopics) && <div className="flex flex-row gap-2 justify-between mt-2">
          <div className="flex flex-row gap-2">
            ...
            {conversationTopicsNumber > INCREMENT_TOPICS_NUMBER && <button className="btn btn-secondary" 
              onClick={() => setConversationTopicsNumber(conversationTopicsNumber - INCREMENT_TOPICS_NUMBER)}
...
export function TopicSwitcher() {
  ...
  return (
    <div className="flex flex-row gap-2 justify-end -mt-2">
      <button className={`w-5 h-5 filter brightness-150 cursor-pointer mr-3 ${!isFloating ? "tooltip" : ""}`} 
        data-tip={title} title={title} onClick={() => setShowTopics(!showTopics)}>
        <svg strokeWidth="0" fill={isFloating ? "#6a7282" : "white"} viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M912 192H328c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8h584c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8zm0 284H328c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8h584c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8zm0 284H328c-4.4 0-8 3.6-8 8v56c0 4.4 3.6 8 8 8h584c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8zM104 228a56 56 0 1 0 112 0 56 56 0 1 0-112 0zm0 284a56 56 0 1 0 112 0 56 56 0 1 0-112 0zm0 284a56 56 0 1 0 112 0 56 56 0 1 0-112 0z"></path></svg>
      </button>
    </div>
  )
}
